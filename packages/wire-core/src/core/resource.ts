import type { JsonObject, JsonValue, Resource, Source } from "./model.js";
...
export function resourceId(source: Source): string {
  ...
  return Object.freeze({
    ...
    relationships: Object.freeze(
      resource.relationships
        .map((relationship) =>
          Object.freeze({ target_id: relationship.target_id, type: relationship.type, data: cloneObject(relationship.data) }),
        )
